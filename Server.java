...
public class Server {
        ...
        switch (command.toLowerCase()) {
            ...
            case "login":
                ...
                if (loginDetails.length == 2) {
                    ...
                    promptForAdditionalDetails(out, loginDetails[0]);
                } else {
    ...
    private static void promptForAdditionalDetails(PrintWriter out, String username) {
        out.println("Please enter your school name:");
        String schoolName = readInputFromClient();
        out.println("Please enter your year of attempt:");
        String yearOfAttempt = readInputFromClient();

        // Proceed with the normal functionality
        out.println("Welcome " + username + " from " + schoolName + ", year of attempt: " + yearOfAttempt + ".");
        // Continue with the participant's normal functionality here...
    }

    private static String readInputFromClient() {
